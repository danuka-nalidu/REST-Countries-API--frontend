      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          <div className="text-center">
            ...
            >
              <GlobeIcon className="h-16 w-16 text-blue-500" />
            </motion.div>
            <motion.h2
          ...
          {error && (
            <motion.div
              className="bg-red-50 border-l-4 border-red-500 p-4 rounded mt-6"
        ...
        >
          <div className="flex justify-center mb-4">
            <img src="/world-map.png" alt="World Map" className="h-24" />
          </div>
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Explore the World</h3>
          <p className="text-gray-600">
            Sign in to save your favorite countries and create your personalized travel bucket list.
          </p>
        </motion.div>
      </div>
    </div>
